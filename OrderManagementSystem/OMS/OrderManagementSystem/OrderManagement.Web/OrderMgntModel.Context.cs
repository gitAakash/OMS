...
public partial class OrderMgntEntities : DbContext
{
    ...
    public DbSet<EventEmailORPrint> EventEmailORPrints { get; set; }
    public DbSet<Client> Clients { get; set; }
    public DbSet<Video> Videos { get; set; }
    public DbSet<JobAnnotation> JobAnnotations { get; set; }
    ...
    public virtual ObjectResult<SelectJobAttachmentFolders> SelectJobAttachmentFolders(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> jobId)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectJobAttachmentFolders>("SelectJobAttachmentFolders", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, jobIdParameter);
    }
    ...
    public virtual ObjectResult<SelectEventsBySearchValue> SelectEventsBySearchValue(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, string searchValue)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectEventsBySearchValue>("SelectEventsBySearchValue", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, searchValueParameter);
    }

    public virtual ObjectResult<GetEventPrintData> GetEventPrintData(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, string eventId)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetEventPrintData>("GetEventPrintData", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, eventIdParameter);
    }
    ...
    public virtual ObjectResult<GetEventEmailORPrintData> GetEventEmailORPrintData(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetEventEmailORPrintData>("GetEventEmailORPrintData", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter);
    }
    ...
    public virtual ObjectResult<SelectCommunicationTemplate> SelectCommunicationTemplate(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, string tEMPLATE_TYPE, Nullable<bool> pRINT, Nullable<bool> eMAIL)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectCommunicationTemplate>("SelectCommunicationTemplate", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, tEMPLATE_TYPEParameter, pRINTParameter, eMAILParameter);
    }
    ...
    public virtual ObjectResult<SelectClients> SelectClients(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, string searchValue, Nullable<int> row_id)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectClients>("SelectClients", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, searchValueParameter, row_idParameter);
    }

    public virtual int DeleteClients(Nullable<int> row_Id, Nullable<int> user_Id)
    {
        var row_IdParameter = row_Id.HasValue ?
            new ObjectParameter("Row_Id", row_Id) :
            new ObjectParameter("Row_Id", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteClients", row_IdParameter, user_IdParameter);
    }

    public virtual int UpdateClients(Nullable<int> org_Id, Nullable<int> client_Id, Nullable<int> user_id, string name, string main_Phone, string main_Email, string main_URL, Nullable<bool> isDeleted)
    {
        var org_IdParameter = org_Id.HasValue ?
            new ObjectParameter("Org_Id", org_Id) :
            new ObjectParameter("Org_Id", typeof(int));
        ...
        var main_PhoneParameter = main_Phone != null ?
            new ObjectParameter("Main_Phone", main_Phone) :
            new ObjectParameter("Main_Phone", typeof(string));

        var main_EmailParameter = main_Email != null ?
            new ObjectParameter("Main_Email", main_Email) :
            new ObjectParameter("Main_Email", typeof(string));

        var main_URLParameter = main_URL != null ?
            new ObjectParameter("Main_URL", main_URL) :
            new ObjectParameter("Main_URL", typeof(string));

        var isDeletedParameter = isDeleted.HasValue ?
            new ObjectParameter("IsDeleted", isDeleted) :
            new ObjectParameter("IsDeleted", typeof(bool));

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateClients", org_IdParameter, client_IdParameter, user_idParameter, nameParameter, main_PhoneParameter, main_EmailParameter, main_URLParameter, isDeletedParameter);
    }

    public virtual ObjectResult<SelectVideo> SelectVideo(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> cOMPANY_ID, string searchValue, Nullable<int> clientId)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectVideo>("SelectVideo", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, cOMPANY_IDParameter, searchValueParameter, clientIdParameter);
    }

    public virtual int InsertVideo(Nullable<int> org_Id, Nullable<int> client_Id, Nullable<int> user_id, string title, string fileName, string fileExtension, Nullable<int> fileSize, string file_s3_location, string reference, string host_Primary, string host_Primary_Link, string host_Secondary, string host_Secondary_Link, string comments, string status, Nullable<bool> isDeleted, Nullable<int> job_Id)
    {
        var org_IdParameter = org_Id.HasValue ?
            new ObjectParameter("Org_Id", org_Id) :
            new ObjectParameter("Org_Id", typeof(int));
        ...
        var file_s3_locationParameter = file_s3_location != null ?
            new ObjectParameter("File_s3_location", file_s3_location) :
            new ObjectParameter("File_s3_location", typeof(string));

        var referenceParameter = reference != null ?
            new ObjectParameter("Reference", reference) :
            new ObjectParameter("Reference", typeof(string));

        var host_PrimaryParameter = host_Primary != null ?
            new ObjectParameter("Host_Primary", host_Primary) :
            new ObjectParameter("Host_Primary", typeof(string));

        var host_Primary_LinkParameter = host_Primary_Link != null ?
            new ObjectParameter("Host_Primary_Link", host_Primary_Link) :
            new ObjectParameter("Host_Primary_Link", typeof(string));

        var host_SecondaryParameter = host_Secondary != null ?
            new ObjectParameter("Host_Secondary", host_Secondary) :
            new ObjectParameter("Host_Secondary", typeof(string));

        var host_Secondary_LinkParameter = host_Secondary_Link != null ?
            new ObjectParameter("Host_Secondary_Link", host_Secondary_Link) :
            new ObjectParameter("Host_Secondary_Link", typeof(string));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertVideo", org_IdParameter, client_IdParameter, user_idParameter, titleParameter, fileNameParameter, fileExtensionParameter, fileSizeParameter, file_s3_locationParameter, referenceParameter, host_PrimaryParameter, host_Primary_LinkParameter, host_SecondaryParameter, host_Secondary_LinkParameter, commentsParameter, statusParameter, isDeletedParameter, job_IdParameter);
    }

    public virtual int UpdateVideo(Nullable<int> org_Id, Nullable<int> client_Id, Nullable<int> user_id, string title, string fileName, string fileExtension, Nullable<int> fileSize, string file_s3_location, string reference, string host_Primary, string host_Primary_Link, string host_Secondary, string host_Secondary_Link, string comments, string status, Nullable<bool> isDeleted, Nullable<int> row_Id, Nullable<int> job_Id)
    {
        var org_IdParameter = org_Id.HasValue ?
            new ObjectParameter("Org_Id", org_Id) :
            new ObjectParameter("Org_Id", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateVideo", org_IdParameter, client_IdParameter, user_idParameter, titleParameter, fileNameParameter, fileExtensionParameter, fileSizeParameter, file_s3_locationParameter, referenceParameter, host_PrimaryParameter, host_Primary_LinkParameter, host_SecondaryParameter, host_Secondary_LinkParameter, commentsParameter, statusParameter, isDeletedParameter, row_IdParameter, job_IdParameter);
    }

    public virtual int DeleteVideo(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> vIDEO_ID)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteVideo", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, vIDEO_IDParameter);
    }

    public virtual ObjectResult<GetVideoById> GetVideoById(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> cOMPANY_ID, string searchValue, Nullable<int> videoId)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetVideoById>("GetVideoById", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, cOMPANY_IDParameter, searchValueParameter, videoIdParameter);
    }

    public virtual ObjectResult<GetAllJobs> GetAllJobs(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllJobs>("GetAllJobs", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter);
    }

    public virtual ObjectResult<SelectVideoById> SelectVideoById(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> cOMPANY_ID, string searchValue, Nullable<int> videoId)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectVideoById>("SelectVideoById", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, cOMPANY_IDParameter, searchValueParameter, videoIdParameter);
    }

    public virtual ObjectResult<GetJobCommentsById> GetJobCommentsById(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> rOW_ID)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetJobCommentsById>("GetJobCommentsById", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, rOW_IDParameter);
    }

    public virtual int UpdateJobAttachmentComments(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> fILE_ID, string cOMMENTS, Nullable<bool> iSDELETED, Nullable<int> cOMMENT_ID)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateJobAttachmentComments", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, fILE_IDParameter, cOMMENTSParameter, iSDELETEDParameter, cOMMENT_IDParameter);
    }

    public virtual ObjectResult<GetFoldersAttachmentCount> GetFoldersAttachmentCount(Nullable<int> job_Id, Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID)
    {
        var job_IdParameter = job_Id.HasValue ?
            new ObjectParameter("job_Id", job_Id) :
            new ObjectParameter("job_Id", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetFoldersAttachmentCount>("GetFoldersAttachmentCount", job_IdParameter, oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter);
    }

    public virtual ObjectResult<GetUserCommentsbyJobId> GetUserCommentsbyJobId(Nullable<int> file_id, Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID)
    {
        var file_idParameter = file_id.HasValue ?
            new ObjectParameter("File_id", file_id) :
            new ObjectParameter("File_id", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetUserCommentsbyJobId>("GetUserCommentsbyJobId", file_idParameter, oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter);
    }

    public virtual int UpdateJobAttachmentUploaded(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> jobAttachmentId, string uPLOAD_STATUS)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateJobAttachmentUploaded", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, jobAttachmentIdParameter, uPLOAD_STATUSParameter);
    }

    public virtual ObjectResult<SelectJobAttachmentComment_Result> SelectJobAttachmentComment(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> job_Id)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectJobAttachmentComment_Result>("SelectJobAttachmentComment", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, job_IdParameter);
    }

    public virtual int UpdateJobEmail_Notification(Nullable<int> jobId, string email__Notification)
    {
        var jobIdParameter = jobId.HasValue ?
            new ObjectParameter("JobId", jobId) :
            new ObjectParameter("JobId", typeof(int));

        var email__NotificationParameter = email__Notification != null ?
            new ObjectParameter("Email__Notification", email__Notification) :
            new ObjectParameter("Email__Notification", typeof(string));

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateJobEmail_Notification", jobIdParameter, email__NotificationParameter);
    }

    public virtual ObjectResult<SelectJobAttachmentFolders> SelectJobAttachmentFolders1(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> jobId)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectJobAttachmentFolders>("SelectJobAttachmentFolders1", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, jobIdParameter);
    }

    public virtual int UpdateJobstatus(Nullable<int> jobId, Nullable<int> updatedBy, Nullable<int> org_Id)
    {
        var jobIdParameter = jobId.HasValue ?
            new ObjectParameter("JobId", jobId) :
            new ObjectParameter("JobId", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateJobstatus", jobIdParameter, updatedByParameter, org_IdParameter);
    }

    public virtual ObjectResult<GetJobAnnotationById> GetJobAnnotationById(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> rOW_ID)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetJobAnnotationById>("GetJobAnnotationById", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, rOW_IDParameter);
    }

    public virtual int InsertJobAnnotation(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> fILE_ID, string annotationText, Nullable<bool> iSDELETED)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        var annotationTextParameter = annotationText != null ?
            new ObjectParameter("AnnotationText", annotationText) :
            new ObjectParameter("AnnotationText", typeof(string));

        var iSDELETEDParameter = iSDELETED.HasValue ?
            new ObjectParameter("ISDELETED", iSDELETED) :
            new ObjectParameter("ISDELETED", typeof(bool));

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertJobAnnotation", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, fILE_IDParameter, annotationTextParameter, iSDELETEDParameter);
    }

    public virtual ObjectResult<GetEmailTemplateData_Result> GetEmailTemplateData(Nullable<int> job_Id, Nullable<int> org_Id)
    {
        var job_IdParameter = job_Id.HasValue ?
            new ObjectParameter("Job_Id", job_Id) :
            new ObjectParameter("Job_Id", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetEmailTemplateData_Result>("GetEmailTemplateData", job_IdParameter, org_IdParameter);
    }

    public virtual int UpdateJobAttachmentTags(string tags, Nullable<int> row_Id, Nullable<int> org_Id, Nullable<int> job_Id)
    {
        var tagsParameter = tags != null ?
            new ObjectParameter("Tags", tags) :
            new ObjectParameter("Tags", typeof(string));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateJobAttachmentTags", tagsParameter, row_IdParameter, org_IdParameter, job_IdParameter);
    }

    public virtual int UpdateConfirmSelectImage()
    {
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateConfirmSelectImage");
    }

    public virtual int UpdateImageSelection(string rowId, Nullable<int> jobId)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateImageSelection", rowIdParameter, jobIdParameter);
    }
    ...
    public virtual int UpdateFolderLock(Nullable<int> jobId, Nullable<int> rowId)
    {
        var jobIdParameter = jobId.HasValue ?
            new ObjectParameter("jobId", jobId) :
            new ObjectParameter("jobId", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateFolderLock", jobIdParameter, rowIdParameter);
    }

    public virtual ObjectResult<SelectJobAttachmentTemplate_Result> SelectJobAttachmentTemplate(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> jOB_ID, string fOLDER)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectJobAttachmentTemplate_Result>("SelectJobAttachmentTemplate", oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, jOB_IDParameter, fOLDERParameter);
    }

    public virtual int InsertEmailsToEmailInbox(string tO_EMAIL, string fROM_EMAIL, string cC_EMAIL, string bCC_EMAIL, string sUBJECT, string mESSAGE_BODY, Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, string fOLDER_NAME)
    {
        var tO_EMAILParameter = tO_EMAIL != null ?
            new ObjectParameter("TO_EMAIL", tO_EMAIL) :
            new ObjectParameter("TO_EMAIL", typeof(string));
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertEmailsToEmailInbox", tO_EMAILParameter, fROM_EMAILParameter, cC_EMAILParameter, bCC_EMAILParameter, sUBJECTParameter, mESSAGE_BODYParameter, oRG_IDParameter, uSER_IDParameter, uSER_TYPEParameter, uSER_COMPANY_IDParameter, fOLDER_NAMEParameter);
    }

    public virtual int InsertJobAttachment(Nullable<int> oRG_ID, Nullable<int> uSER_ID, string uSER_TYPE, Nullable<int> uSER_COMPANY_ID, Nullable<int> job_Id, string fileName, string fileExtension, Nullable<int> fileSize, string groupType, string tags, string folder, string filePath, string thumbImgPath, Nullable<int> selected, Nullable<int> row_id, Nullable<int> isDeleted)
    {
        var oRG_IDParameter = oRG_ID.HasValue ?
            new ObjectParameter("ORG_ID", oRG_ID) :
            new ObjectParameter("ORG_ID", typeof(int));
        ...
        var thumbImgPathParameter = thumbImgPath != null ?
            new ObjectParameter("ThumbImgPath", thumbImgPath) :
            new ObjectParameter("ThumbImgPath", typeof(string));

        var selectedParameter = selected.HasValue ?
            new ObjectParameter("Selected", selected) :
            new ObjectParameter("Selected", typeof(int));
